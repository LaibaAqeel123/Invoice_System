    ...
    <div class="invoice-container">
            ...
            <div class="logo-section">
                ...
                <?php else: ?>
                    ...
                    <div class="company-info-text">
                        <div class="company-name-text"><?php echo htmlspecialchars($invoice['template_company_name']); ?></div>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="footer-info">
            <div class="footer-company">
                <strong><?php echo htmlspecialchars($invoice['template_company_name']); ?></strong>
            </div>
